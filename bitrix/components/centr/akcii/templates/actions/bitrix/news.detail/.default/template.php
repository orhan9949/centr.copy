					...
					<div class="post-date">
						<span class="date-wrapper">	
							<? $date_created = $arResult["DISPLAY_ACTIVE_FROM"]; 
								...
								$month_array = array("1"=>"ЯНВ","2"=>"ФЕВ","3"=>"МАР","4"=>"АПР","5"=>"МАЙ", "6"=>"ИЮН", "7"=>"ИЮЛ","8"=>"АВГ","9"=>"СЕН","10"=>"ОКТ","11"=>"НОЯ","12"=>"ДЕК");
		...
		<ul class="pager blog-pager">
			<li class="previous">
				<a href="/company/akcii/" class="direction">
					<i class="fa fa-long-arrow-left"></i>Все акции
					<h4 class="post-title">Вернуться ко всем акциям</h4>
				</a>
			</li>
		</ul>
